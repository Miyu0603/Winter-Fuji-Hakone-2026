...
export const PrepView: React.FC<PrepViewProps> = ({ checkedItems, toggleItem }) => {
  return (
    <div className="pb-32 pt-6 px-5 max-w-lg mx-auto animate-in fade-in slide-in-from-bottom-2 duration-500">
      ...
      {/* Section 1: Notes */}
      <div className="mb-10">
        <h2 className="text-xs font-bold tracking-[0.2em] text-mag-gray uppercase mb-4 pl-1">注意事項</h2>
        <div className="bg-mag-white rounded-xl shadow-soft border border-gray-100 p-6 relative overflow-hidden">
          ...
          <ul className="space-y-4">
            {PRE_TRIP_NOTES.map((note, idx) => (
              <li key={idx} className="flex gap-4 text-mag-black text-sm leading-relaxed font-medium">
      ...
      {/* Section 2: Checklist */}
      <div>
        <h2 className="text-xs font-bold tracking-[0.2em] text-mag-gray uppercase mb-4 pl-1">待辦事項</h2>
